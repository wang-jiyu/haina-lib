...
var NativeJs = /** @class */ (function () {
    ...
    NativeJs.cangoback = function (goback) {
        exports.baseNativeJs("cangoback", {});
    };
    /**
     * 控制改变toolbar颜色与标题
     * @param title
     ...
     * 调起支付sdk
     */
    NativeJs.startPay = function (order_id, prepay, paymethod) {
        exports.baseNativeJs("startPay", { order_id: order_id, prepay: prepay, paymethod: paymethod });
    };
    /**
     * 直接调起适当性认证
     */
     ...
     * 线下支付提示
     */
    NativeJs.offlineAlert = function () {
        exports.baseNativeJs("offlineAlert");
    };
    return NativeJs;
}());
